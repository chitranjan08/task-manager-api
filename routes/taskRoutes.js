...
router.post('/create',verifyToken,authorizeRoles(ROLES.ADMIN, ROLES.MANAGER),validate(ValidateSchema.taskSchema)),  // Optional: If you're validating creationtaskController.createTask);
...
router.post('/update',verifyToken,validate(ValidateSchema.updateTaskSchema),taskController.updateTask);
